        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (!_leftMouseClick && currentMouseState.LeftButton == ButtonState.Pressed)
            {
                ...
                for (int i = _starList.Count - 1; i >= 0; i--)
                {
                    ...
                    {
                        _explosionList.Add(new Explosion(currentMouseState.X, currentMouseState.Y, Content.Load<Texture2D>("explosionSpritesheet")));
