    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for (int index = 0; index < _listOfObstacles.Count; index++)
            {
                ...
                //This is where our change direction logic should go - if a gremlin
                //hits an obstacle, it should turn around.
            ...
            //check for collisions between the hero and chests. Put that logic here.
            ...
            //did the hero pick up any coins? Put that logic here.
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (showBounds)
            {
                ...
                //this is one of the Code Quest 10 things to do, but I'm leaving it in
                //here as a freebie. Simply uncomment these two lines when you've added
                //your coin class GetBounds() method.
