...
namespace CQ12SpaceStart
{
    ...
    internal class Hero
    {
        ...
        private SoundEffect _heroWalkingSound;
        private SoundEffectInstance _heroWalkingSoundInstance;

        //a constructor to set the default attribute values
        public Hero(float heroX, float heroY, int heroHealth, float heroSpeed, Texture2D heroSpriteSheet, SoundEffect heroWalkingSound)
        {
