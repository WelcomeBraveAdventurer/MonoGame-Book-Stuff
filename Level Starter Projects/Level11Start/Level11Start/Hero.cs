...
public Hero(float heroX, float heroY, int heroHealth, float heroSpeed, Texture2D heroSprite)
{
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (_heroMovingRight)
                spriteBatch.Draw(_heroSprite, new Vector2(_heroX, _heroY), new Rectangle(64, 64, 64, 64), Color.White, 0, new Vector2(0, 0), 1, SpriteEffects.None, 0);
            else
                spriteBatch.Draw(_heroSprite, new Vector2(_heroX, _heroY), new Rectangle(64, 64, 64, 64), Color.White, 0, new Vector2(0, 0), 1, SpriteEffects.FlipHorizontally, 0);
            spriteBatch.End();
        }
