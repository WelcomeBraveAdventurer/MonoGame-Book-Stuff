...
namespace Project3Start
{
    ...
    internal class Gremlin
    {
        ...
        private bool _gremlinMovingRight, _gremlinIsAttacking, _gremlinIsDead, _deathAnimationOver;
        ...
        public Gremlin(float gremlinX, float gremlinY, int gremlinHealth, float gremlinSpeed, Texture2D gremlinSprite, SpriteFont gremlinFont)
        {
        ...
        public bool IsDead() { return _deathAnimationOver; }
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_gremlinFont, "Health: " + _gremlinHealth, new Vector2(_gremlinX + 64 - _gremlinFont.MeasureString("Health: " + _gremlinHealth).X / 2, _gremlinY - 10), Color.White);
            ...
            if (!_gremlinMovingRight)
                ...
                spriteBatch.Draw(_gremlinSprite, new Vector2(_gremlinX, _gremlinY), new Rectangle(_animationIndex * 128, _animationRow * 96, 128, 96), Color.White, 0, new Vector2(0, 0), 1, SpriteEffects.FlipHorizontally, 0);
            spriteBatch.End();
        }
