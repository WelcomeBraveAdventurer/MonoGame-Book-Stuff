...
namespace CQ10StarDone
{
    internal class Star
    {
        ...
        //these help when we want to know the coordinates of the star
        public float GetX() { return _starX; }
        public float GetY() { return _starY; }

        //this will return our star's hit box
        ...
        //there's not a lot in here, but it controls the star rotating and falling
        public void Update()
        {
            if (_rotateClockwise)
            ...
            //gently fall down the screen
            _starY += _starSpeed;
        }


        //draw the star to our scene
