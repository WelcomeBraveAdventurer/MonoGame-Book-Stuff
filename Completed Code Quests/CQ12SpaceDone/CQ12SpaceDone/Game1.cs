...
private List<Hero> _listOfHeroes;
        ...
        protected override void LoadContent()
        {
            ...
            _listOfHeroes.Add(new Hero(300, 100, 10, 5, Content.Load<Texture2D>("heroSpriteSheet"), Content.Load<SoundEffect>("footstepsBoots"), Content.Load<SoundEffect>("punchSound"), Content.Load<SoundEffect>("pixelDeathSound")));
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            for (int index = 0; index < _listOfObstacles.Count; index++)
            {
                ...
                {
                    _listOfGremlins[0].ChangeDirection();
                }
            }
