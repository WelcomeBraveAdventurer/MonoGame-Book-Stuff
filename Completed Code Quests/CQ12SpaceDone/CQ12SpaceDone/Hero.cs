...
namespace CQ12SpaceDone
{
    ...
    internal class Hero
    {
        ...
        public Hero(float heroX, float heroY, int heroHealth, float heroSpeed, Texture2D heroSpriteSheet, SoundEffect heroWalkingSound, SoundEffect heroHurtSound, SoundEffect heroDeathSound)
        {
