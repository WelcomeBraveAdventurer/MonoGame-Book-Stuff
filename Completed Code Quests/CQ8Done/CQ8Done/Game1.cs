...
namespace CQ8Done
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //create the health pick up
            _healthPickup = new HealthPickup(400, 100, Content.Load<Texture2D>("healthVial"));

            //create the gremlin
            _gremlin = new Gremlin(500, 100, 10, 5, Content.Load<Texture2D>("gremlin"));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _healthPickup.Draw(_spriteBatch);
            ...
            _spriteBatch.DrawString(_gameFont, "Gremlin health: " + _gremlin.GetHealth(),
