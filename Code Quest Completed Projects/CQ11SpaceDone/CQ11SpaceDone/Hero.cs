...
{
    //this is an enum to give us named states for our hero
    enum HeroStates
    {
    ...
    internal class Hero
    {
        ...
        private bool _heroMovingRight, _heroIsShooting;    //to flip the sprite when needed

        //these variables will help us manage collisions with walls and determine if the hero is dead
        private bool _heroBlockLeft, _heroBlockRight, _heroBlockUp, _heroBlockDown, _heroIsDead;

        //the hero has a state that we track for animations
        ...
        //this stops the movement when the hero hits an obstacle
        ...
        //this is our knockback when we take damage from the gremlin
        ...
        public void Update()
        {
            ...
            //a lot of the new code in here is to track the hero state so that we know 
            //which animation to play and how many frames to run through.
